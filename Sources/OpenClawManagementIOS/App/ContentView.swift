...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(
                colors: [OC.Colors.windowBackground, OC.Colors.windowBackgroundDeep],
            ...
            VStack(spacing: 0) {
                HStack {
                    VStack(alignment: .leading, spacing: OC.Spacing.xs) {
                        Text("BRODERLABS")
                            .font(OC.Typography.caption.weight(.semibold))
                            .tracking(2)
                            ...
                            Button(action: {
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: OC.Radius.pill)
                                        .fill(selectedTab == tab ? OC.Colors.accentSubtle : OC.Colors.surface)
                                )
                                .overlay(
                                    RoundedRectangle(cornerRadius: OC.Radius.pill)
                                        .stroke(selectedTab == tab ? OC.Colors.borderAccent : OC.Colors.border, lineWidth: 1)
                                )
